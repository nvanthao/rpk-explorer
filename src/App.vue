...
<template>
  <div class="flex h-screen flex-col bg-stone-50 text-stone-900 dark:bg-stone-950 dark:text-stone-100">
    <header class="flex flex-wrap items-center gap-3 border-b border-stone-200 px-4 py-3 dark:border-stone-800">
      ...
      <SearchBar v-model="searchQuery" :match-count="matchCount" class="ml-auto" />
      <button
        type="button"
        class="rounded-lg border border-stone-300 px-3 py-2 text-xs font-medium text-stone-600 transition hover:bg-stone-100 dark:border-stone-700 dark:text-stone-300 dark:hover:bg-stone-800"
        @click="collapseAll"
      >
        Collapse all
      </button>
